...
const VisualizationTutorial = ({ myPid, conversation_id, currentIndex }) => {
    ...
    const changeCuration = (newCuration) => {
        ...
        if (visObject) {
            ...
            if (_.isNull(newCuration)) {
                ...
                console.log("changed to majority")
...
export default VisualizationTutorial;